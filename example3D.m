...
load( '~/Documents/ambrose/motionDetector/stimuli/monogenic/exampleim.mat', 'mv');
D = repmat(mv, [1 1 128]);
D = rand(64,64,64)
[Y,X,Z] = size(D);
...
allfilt = cat(4,filtStruct.ReiszFilt12, filtStruct.ReiszFilt03, filtStruct.bpFilt);

%spatial = freq2spat(allfilt, X, Y, Z);
